...
export default function Home() {
  ...
  async function saveEmployee(e) {
    ...
    const payload = {
      ...
      matricula:
        newEmployee.matricula.trim() || null,
      funcao:
        newEmployee.funcao.trim() || null,
      empresa:
        newEmployee.empresa.trim() || null,
      setor:
        newEmployee.setor.trim() || null,
      data_admissao:
        newEmployee.data_admissao || null
    };
  ...
  async function saveEpi(e) {
    ...
    const payload = {
      ...newEpi,
      nome: newEpi.nome.trim(),
      categoria:
        newEpi.categoria.trim() || null,
      ca: newEpi.ca.trim() || null,
      unidade:
        newEpi.unidade.trim() || "UN"
    };

    const query = editingEpi
      ? supabase
          .from("epis")
          .update(payload)
          .eq("id", editingEpi.id)
  ...
  return (
    <div className="sheet">
      ...
      <p className="term">
        ...
        conservação e comunicar
        qualquer dano, perda ou
        necessidade de substituição,
        conforme as orientações de
